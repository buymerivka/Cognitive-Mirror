...
const AnalyzeEmotions: React.FC = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            const response: SingleAnalyze = await fetchAnalyze(payload);
        ...
        <div className={styles.page}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.filters}>
                    <span className={styles.filterTitle}>Show emotions:</span>
                    <div className={styles.checkboxGroup}>
                        {Object.keys(selectedEmotions)
                            .filter((e) => e !== "neutral")
                            .map((emotion) => (
                                <label key={emotion} className={styles.checkboxLabel}>
                                    <input
                                        type="checkbox"
                ...
                {analyzedData && (
                    <div className={styles.result}>
                        ...
                        <div className={styles.resultButtons}>
                            <button style={ {marginRight: "20px", width: "210px", backgroundColor: "#4caf50"} } onClick={handleDownloadJson}>Download JSON</button>
